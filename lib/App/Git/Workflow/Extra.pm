...
App::Git::Workflow::Extra - <One-line description of module's purpose>

=head1 VERSION

This documentation refers to App::Git::Workflow::Extra version 0.0.1
